...
imagenet_data_dir = os.path.expanduser("/home/ntu329/Documents/Datasets/ImageNet/")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--apex', action='store_true', help='Use NVIDIA Apex (float16 precision).')
